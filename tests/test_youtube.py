...
def test():
    ...
    general_evaluation_by_ai_str = llm.invoke(interview_question_query).content

    # Detailed evaluation of the candidate response by AI
    detailed_evaluation_by_ai_str = llm.invoke(check_leadership_principle_prompt).content
